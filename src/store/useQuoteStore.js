...
const savedMirrorStats =
  JSON.parse(localStorage.getItem("mirrorBest")) || {};

const savedReactionStats =
  JSON.parse(localStorage.getItem("reactionBest")) || {};

const savedMemoryStats =
  JSON.parse(localStorage.getItem("memoryBest")) || {};

const savedEchoStats =
...
const useQuoteStore = create((set) => ({
  ...
  saveMemoryStats: (current) => {
    set((state) => {
      ...
      localStorage.setItem("memoryBest", JSON.stringify(newBest));
